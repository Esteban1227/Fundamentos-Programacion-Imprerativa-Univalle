...
# messageResult: cadena de texto alfanumerico que concatena el message + date + "/" + month + "/" + age'(Este varia dependiendo de la cedula ingresada) Ej: Su fecha limite es el 19 Agosto 2021
...
# '1107837835', para este CC la fecha limite del usuario para hacer la declaracion de renta es eL 2 de Septiempre.
# '1107837895', para este CC la fecha limite del usuario para hacer la declaracion de renta es eL 14 de Ocutibre.
# '1107837800', para este CC la fecha limite del usuario para hacer la declaracion de renta es eL 19 de Ocutibre.
...
#PRUEBA #1: Si ingresa el valor al programa '11078378509', da como resultado que la fecha limite para hacer la declaracion de renta es el 16 de Agosto del 2021.
    #CC = '09'
    #messageResult = 'Su fecha limite para hacer la declaracion de renta es el: 16/Agosto/2021'
...
#PRUEBA #2: Si ingresa el valor al programa '11078378535', da como resultado que la fecha limite para hacer la declaracion de renta es el 2 de Septiempre del 2021.
    #CC = '35'
    #messageResult = 'Su fecha limite para hacer la declaracion de renta es el: 2/Septiembre/2021'
...
#PRUEBA #3: Si ingresa el valor al programa '11078378595', da como resultado que la fecha limite para hacer la declaracion de renta es el 14 de Octubre del 2021.
    #CC = '95'
    #messageResult = 'Su fecha limite para hacer la declaracion de renta es el: 14/Octubre/2021'
...
#PRUEBA #4: Si ingresa el valor al programa '11078378500', da como resultado que la fecha limite para hacer la declaracion de renta es el 19 de Octubre del 2021.
    #CC = '00'
    #messageResult = 'Su fecha limite para hacer la declaracion de renta es el: 19/Octubre/2021'
