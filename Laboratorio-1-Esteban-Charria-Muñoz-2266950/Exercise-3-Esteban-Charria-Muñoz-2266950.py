...
# Si la materia es matematicas y las notas de las 3 tareas son 5.0, 4.5, 5.0 y la nota del examen es 5.0 el estudiante aprobaria la materia y su nota definitiva seria 5.0
...
# Probar el programa:
#Prueba #1 Si ingresamos en el primer input un '1' y digitamos las siguientes notas de tareas 5.0, 4.5, 5.0 y en la nota del examen ponemos 5.0 el resultado seria '¡Felicidades usted APROBO matematicas! Su nota definitiva es de 5.0' 
    # matter = matematicas
    # homeworkNote1 = 5.0
    # homeworkNote2 = 4.5
    # homeworkNote3 = 5.0
    # noteTest = 5.0
    # messageResult = '¡Felicidades usted APROBO matematicas! Su nota definitiva es de 5.0'
...
#Prueba #5 Si ingresamos en el primer input un '3' y digitamos las siguientes notas de tareas 3.0, 3.5, 3.0 y en la nota del examen ponemos 3.0 el resultado seria ¡Felicidades usted APROBO quimica! Su nota definitiva es 3.0 
    # matter = quimica
    # homeworkNote1 = 3.0
    # homeworkNote2 = 3.5
    # homeworkNote3 = 3.0
...
#Prueba #6 Si ingresamos en el primer input un '3' y digitamos las siguientes notas de tareas 1.0, 3.0, 2.0 y en la nota del examen ponemos 2.0 el resultado seria 'Lo lamento usted Reprobo quimica Su nota definitiva es 2.0' 
    # matter = quimica
    # homeworkNote1 = 1.0
    # homeworkNote2 = 3.0
    # homeworkNote3 = 2.0
